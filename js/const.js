...
export const uploadPictureInput = uploadPictureForm.querySelector('.img-upload__input');
export const uploadPictureOverlay = uploadPictureForm.querySelector('.img-upload__overlay');
export const uploadPictureFormCancel = uploadPictureForm.querySelector('.img-upload__cancel');
export const hashtagInput = uploadPictureForm.querySelector('.text__hashtags');
export const descriptionInput = uploadPictureForm.querySelector('.text__description');
...
export const bigPictureCancel = bigPicture.querySelector('.big-picture__cancel');
export const img = bigPictureImg.querySelector('img');
export const likes = bigPicture.querySelector('.social__likes');
export const commentsShowCount = bigPicture.querySelector('.social__comment-shown-count');
export const commentsTotalCount = bigPicture.querySelector('.social__comment-total-count');
...
export const uploadPicturePreview = document.querySelector('.img-upload__preview');
export const scaleControlSmaller = document.querySelector('.scale__control--smaller');
export const scaleControlBigger = document.querySelector('.scale__control--bigger');
